...
**h.** *Describe the effect of increasing age on your plot, and explain briefly how this is consistent with the summary output from your model.*

-   Consistently across each of the age categories -- ages 40, 50, 60, 70, and 80 -- the probability of survival decreases in larger increments over time; this trend progressively steepens in its decline in survival proaabibilities for older age groups over time.
